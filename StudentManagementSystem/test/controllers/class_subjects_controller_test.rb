...
class ClassSubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create class_subject" do
    assert_difference("ClassSubject.count") do
      post class_subjects_url, params: { class_subject: { SchoolClass_id: @class_subject.SchoolClass_id, Subject_id: @class_subject.Subject_id, credit: @class_subject.credit, syllabus: @class_subject.syllabus } }, as: :json
    end
  ...
  test "should update class_subject" do
    patch class_subject_url(@class_subject), params: { class_subject: { SchoolClass_id: @class_subject.SchoolClass_id, Subject_id: @class_subject.Subject_id, credit: @class_subject.credit, syllabus: @class_subject.syllabus } }, as: :json
    assert_response :success
  end
